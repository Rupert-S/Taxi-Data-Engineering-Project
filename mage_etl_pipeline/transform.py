...
def transform(df, *args, **kwargs):
    ...
    #drop all the duplicates and reset the index
    ...
    #add the other datetime_dim fields
    ...
    #rate code type is provided in data documentation
    rate_code_type = {
        1 : "Standard rate",
        2 : "JFK",
        3 : "Newark",
    ...
    #create code name column by mapping the code id to the code type
    ...
    #payment type name is provided in data documentation
    payment_type_name = {
        1 : "Credit card",
        2 : "Cash",
        3 : "No charge",
    ...
    #create type name column by mapping the payment type to the type name dictionary
